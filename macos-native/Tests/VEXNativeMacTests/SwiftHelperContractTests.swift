...
final class SwiftHelperContractTests: XCTestCase {
    ...
    func testInstallerReferencesPackagedSwiftHelperBinaryAndProgramArguments() throws {
        ...
        XCTAssertTrue(installerScript.contains("helper_resources_are_current"))
        XCTAssertTrue(installerScript.contains("helper_antileak_is_clear"))
        XCTAssertTrue(installerScript.contains("same_signed_code"))
        XCTAssertTrue(installerScript.contains("codesign_cdhash"))
        XCTAssertTrue(installerScript.contains("Helper resources unchanged; preserving active helper."))
        XCTAssertTrue(installerScript.contains("Recovery evidence is present; helper replacement is required."))
