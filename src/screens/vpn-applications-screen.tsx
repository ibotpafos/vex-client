...
const styles = StyleSheet.create({
  ...
  headerContent: { gap: 12, paddingBottom: 10 },
  ...
  modeButton: { alignItems: 'center', borderRadius: 14, flex: 1, justifyContent: 'center', minHeight: 46, paddingHorizontal: 8 },
  ...
  applicationIcon: { borderRadius: 14, height: 48, width: 48 },
