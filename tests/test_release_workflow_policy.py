...
class ReleaseWorkflowPolicyTest(unittest.TestCase):
    def test_native_reliability_ci_covers_awg3_recovery_targets(self) -> None:
        ...
        for required in (
            ...
            "--filter NativeParityModelTests",
            "--filter VEXSessionStoreTests",
            "--filter SparkleUpdateTests",
            "--filter VEXPrivilegedHelperCoreTests/testPFEndpointRulesUseValidatedAddressFamilyAndPort",
